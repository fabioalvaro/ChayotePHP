                    ...
                    <tbody>
                        {foreach from=$regs item=reg}
                            <tr>
                                ...
                                <td>
                                    {if $reg.id_perfil neq 1}
                                        <a href="/controleAcesso/perfil/acao/editar/perfil/{$reg.id_perfil}">EDITAR</a> | 
                                        <a href="/controleAcesso/perfil/acao/excluir/perfil/{$reg.id_perfil}">EXCLUIR</a>
                                    {/if}
                                </td>
                            </tr>
                        {foreachelse}
