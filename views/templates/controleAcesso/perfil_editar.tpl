    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <h3 style="text-transform: uppercase;">#{$reg.id_perfil} | {$reg.descricao} - PERFIL</h3>

                <form name="form_controller" method="post" action="/controleAcesso/perfil/acao/salvar">

                    <input type="hidden" id="perfil" name="perfil" value="{$reg.id_perfil}" />
                            ...
                            <tbody>
                                {foreach from=$controllers item=controller}
                                    ...
                                    {foreach from=$controllers_perfil item=perfil}
                                        {if $perfil.id_controller eq $controller.id_controller}
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" id="{$controller.id_controller}" name="controller[]"{$check} value="{$controller.id_controller}" />
                                        </td>
                                        <td style="text-transform: uppercase;"><label style="font-weight: normal; " for="{$controller.id_controller}">{$controller.des}</label></td>
                                    </tr>
                                {foreachelse}
                                    <tr>
