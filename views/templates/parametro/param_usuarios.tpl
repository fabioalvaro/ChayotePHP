 <form id="frm_cad_empresa" name="frm_cad_empresa">
    ...
    <label>Empresa Derivada de:</label>
    ...
    <label>Estado:</label><select name="estado" id="estado"></select>
    <label>Cidade</label>
    ...
    <br/>
    <input type="button" class="btn_padrao" value="Nova Empresa" name="btn_nova_empresa" 
           onclick="btn_salvar_empresa('{$action}')"/>
    <br/>    
    </fieldset>
  </form>